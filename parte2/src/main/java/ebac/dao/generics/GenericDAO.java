...
import ebac.anotation.TipoChave;
...
public abstract class GenericDAO<T extends Persistente, E extends Serializable> implements IGenericDAO<T, E> {
    ...
    public E getChave(T entity) throws TipoChaveNotFound {
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(TipoChave.class)) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new TipoChaveNotFound("Chave principal do objeto " + entity.getClass() + " não encontrada", e);
                }
            }
        }
        if (returnValue == null) {
            ...
            throw new TipoChaveNotFound(msg);
        }
        return null;
    }
